  ...
  return (
    ...
    <div className="w-full min-h-screen lg:grid lg:grid-cols-[1.3fr_1fr] overflow-hidden font-sans">
      {/* --- SISI KIRI (VISUAL / BLUE) --- 
          Copy-paste dari Login Page agar konsisten branding-nya
      */}
      <div className="hidden lg:flex flex-col justify-between bg-primary text-primary-foreground p-12 relative overflow-hidden">
        ...
        {/* Hero Text - Sedikit variasi teks untuk Register */}
        <div className="z-10 mt-20 mb-auto max-w-lg">
          ...
          <p className="text-primary-foreground/80 text-lg leading-relaxed mb-8">
            Join thousands of businesses managing their logistics and analytics
            in one place.
          </p>
        ...
        {/* Dashboard Mockup Image (Sama seperti Login) */}
        ...
        <div className="w-full max-w-105 space-y-7">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start space-x-2 pt-1">
              <Checkbox
                id="terms"
                className="mt-1 data-[state=checked]:bg-primary border-slate-300 rounded"
              />
              <Label
                htmlFor="terms"
